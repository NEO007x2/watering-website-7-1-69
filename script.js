...
// execution function to select function for action
...
document.addEventListener('keydown', (e) => {
  ...
  if (direction) {
    ...
    executeDrive(direction, btnId, antoValue); // call execute function
  }
});
